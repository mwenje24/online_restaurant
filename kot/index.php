						...
						<div class="row m-auto">
							<div class="col-4 rounded-3 mt-2 shadow mx-sm-3">
								...
								<div class="row bg-success">
									<a href="online_orders.php" class="text-center text-light fs-5">Total Online Sales</a>
								</div>
							</div>
							<div class="col-4 mt-2 rounded-3 shadow mx-sm-3">
								...
								<div class="row bg-secondary">
									<a href="kotmeal_orders.php" class="text-center text-light fs-5">Total KOT Sales</a>
								</div>
							</div>
						</div>
						<div class="row mt-3">
